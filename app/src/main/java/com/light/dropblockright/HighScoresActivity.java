...
public class HighScoresActivity extends Activity {
    ...
    void PopulateListView() {
        ...
        String[] selectionArgs = {
                ...
                prefs.getString("num_rows_preference_highscores", "11"),
                prefs.getString("num_columns_preference_highscores", "19"),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (HelpSaveSettings.saveSettingsHighscores == 0) {
            ...
            prefs.edit().putString("num_rows_preference_highscores", "11").apply();
            prefs.edit().putString("num_columns_preference_highscores", "19").apply();
